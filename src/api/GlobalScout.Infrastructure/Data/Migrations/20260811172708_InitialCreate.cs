        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    external_player_id = table.Column<int>(type: "integer", nullable: true),
                    external_provider = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    candidate_first_name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    candidate_last_name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    candidate_club = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    candidate_position = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    candidate_nationality = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    candidate_age = table.Column<int>(type: "integer", nullable: true),
                    candidate_photo_url = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    full_name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    date_of_birth = table.Column<DateOnly>(type: "date", nullable: false),
                    nationality = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    current_club = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    previous_club = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_player_identity_claims", x => x.id);
                    table.ForeignKey(
                        name: "fk_player_identity_claims_users_user_id",
                        column: x => x.user_id,
                        principalTable: "asp_net_users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    external_competition_id = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_reference_competitions", x => x.id);
                    table.ForeignKey(
                        name: "fk_reference_competitions_merged_into",
                        column: x => x.merged_into_competition_id,
                        principalTable: "reference_competitions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    name_normalized = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    external_team_id = table.Column<int>(type: "integer", nullable: true),
                    ...
                    source = table.Column<int>(type: "integer", nullable: false),
                    status = table.Column<int>(type: "integer", nullable: false),
                    merged_into_team_id = table.Column<Guid>(type: "uuid", nullable: true),
                    submitted_by_user_id = table.Column<Guid>(type: "uuid", nullable: true),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_reference_teams", x => x.id);
                    table.ForeignKey(
                        name: "fk_reference_teams_merged_into",
                        column: x => x.merged_into_team_id,
                        principalTable: "reference_teams",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_reference_teams_submitted_by_user",
                        column: x => x.submitted_by_user_id,
                        principalTable: "asp_net_users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_verification_evidence_player_identity_claims_claim_id",
                        column: x => x.claim_id,
                        principalTable: "player_identity_claims",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_player_identity_claims_user_id",
                table: "player_identity_claims",
                column: "user_id",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "user_id", "season", "source" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_reference_competitions_external_competition_id",
                table: "reference_competitions",
                column: "external_competition_id",
                unique: true,
                filter: "external_competition_id IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "ix_reference_competitions_merged_into_competition_id",
                table: "reference_competitions",
                column: "merged_into_competition_id");

            migrationBuilder.CreateIndex(
                name: "ix_reference_competitions_name_normalized",
                table: "reference_competitions",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_reference_competitions_status",
                table: "reference_competitions",
                column: "status");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_reference_teams_external_team_id",
                table: "reference_teams",
                column: "external_team_id",
                unique: true,
                filter: "external_team_id IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "ix_reference_teams_merged_into_team_id",
                table: "reference_teams",
                column: "merged_into_team_id");

            migrationBuilder.CreateIndex(
                name: "ix_reference_teams_name_normalized",
                table: "reference_teams",
                column: "name_normalized")
                .Annotation("Npgsql:IndexMethod", "gin")
                .Annotation("Npgsql:IndexOperators", new[] { "gin_trgm_ops" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_reference_teams_status",
                table: "reference_teams",
                column: "status");

            migrationBuilder.CreateIndex(
                name: "ix_reference_teams_submitted_by_user_id_status",
                table: "reference_teams",
                columns: new[] { "submitted_by_user_id", "status" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_verification_evidence_claim_id",
