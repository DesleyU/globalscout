...
internal sealed class CreateSelfReportedPlayerIdentityClaimCommandValidator
    : AbstractValidator<CreateSelfReportedPlayerIdentityClaimCommand>
{
    public CreateSelfReportedPlayerIdentityClaimCommandValidator()
    {
